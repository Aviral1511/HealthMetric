...
const COLORS = ['#3b82f6', '#10b981', '#f59e0b', '#ef4444', '#8b5cf6', '#06b6d4', '#db2777'];
...
const DashboardCharts = ({ data, filters }) => {
  ...
  if (!data || data.length === 0) {
    return (
      <div className="h-64 flex flex-col items-center justify-center text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-900 rounded-3xl border border-dashed border-slate-300 dark:border-slate-700 w-full xl:col-span-2">
  ...
  const chartClasses = "bg-white dark:bg-[#1e293b] p-6 rounded-3xl shadow-[0_4px_24px_rgba(0,0,0,0.03)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] border border-[#e2e8f0] dark:border-slate-800/80 transition-all hover:shadow-[0_8px_40px_rgba(0,0,0,0.08)] group";

  return (
    <>
      <ChartRecommendation filters={filters} />
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 w-full">
        ...
        <div className={`${chartClasses} xl:col-span-2`}>
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-lg font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2">
