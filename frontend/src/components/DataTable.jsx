      ...
      <div className="p-4 border-t border-[#e2e8f0] dark:border-slate-800 flex items-center justify-between flex-wrap gap-4 bg-slate-50/50 dark:bg-[#1e293b]">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-4 py-2 border border-[#e2e8f0] dark:border-slate-700 bg-white dark:bg-slate-900 dark:text-gray-50 text-gray-800 rounded-lg text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            Prev
          </button>
          <button
